...
# Random Forest
random_forest_params = {'max_depth': 10, 'n_estimators': 100, 'random_state': 123}

# XGBoost
xgboost_params = {'learning_rate': 0.01, 'max_depth': 7, 'n_estimators': 50, 'random_state': 123}

# LightGBM
lightgbm_params = {'learning_rate': 0.01, 'max_depth': 5, 'n_estimators': 100, 'random_state': 123}
...
train_data_rus = pd.read_csv('analysis_outputs/train_data_after_imputation_undersampled.csv')

# Split into features and target variable
train_x = train_data_rus[rfecv_features]
train_y = train_data_rus['Failure level (0 vs 1 to 3) (6M)']
...
# Save the model
joblib_file = f'{output_dir}/FINAL_UNDERSAMPLING/tabpfn/tabpfn_model_UNDERSAMPLING_FINAL.pkl'
...
df_test.to_csv(f'{output_dir}/FINAL_UNDERSAMPLING/tabpfn/Results_UnderSampling_with_pred_proba.csv', index=False)

# Data excluded by undersampling
train_data_excluded = pd.read_csv('analysis_outputs/train_data_after_imputation_excluded.csv')
...
train_data_excluded.to_csv(f'{output_dir}/FINAL_UNDERSAMPLING/tabpfn/Results_Excluded_train_data_with_pred_proba.csv', index=False)
...
with open(f'{output_dir}/FINAL_UNDERSAMPLING/tabpfn/metrics_tabpfn.csv', 'w', newline='') as file:
...
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/tabpfn/roc_curve_tabpfn_final.png', dpi=300)
plt.show()
...
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/tabpfn/confusion_matrix_tabpfn_final.png', dpi=300)
pyplot.show()
...
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/tabpfn/prob_tabpfn_final.png', dpi=300)
plt.show()
...
plt.grid(True)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/tabpfn/sensitivity_specificity_plot_tabpfn_final.png', dpi=300)
plt.show()
...
csv_file_path = 'analysis_outputs/FINAL_UNDERSAMPLING/tabpfn/threshold_metrics_tabpfn.csv'
...
plt.tight_layout()
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/tabpfn/threshold_confusion_matrix_tabpfn.png', dpi=300)
plt.show()
...
output_file_path = 'analysis_outputs/FINAL_UNDERSAMPLING/tabpfn'
...
plt.legend(loc='best')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/tabpfn/calibration_Plot_tabpfn.png', dpi=300)
plt.show()
...
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/tabpfn/shap_summary_plot_tabpfn.png', bbox_inches='tight', dpi=300)
plt.close()
...
# Save the model
joblib_file = f'{output_dir}/FINAL_UNDERSAMPLING/rf/rf_model_UNDERSAMPLING_FINAL.pkl'
...
# Output predicted probabilities for test data to a CSV file
df_test['pred_proba'] = y_pred_proba
df_test.to_csv(f'{output_dir}/FINAL_UNDERSAMPLING/rf/Results_UNDERSAMPLING_with_pred_proba.csv', index=False)
...
# Write metrics to a CSV file.
with open(f'{output_dir}/FINAL_UNDERSAMPLING/rf/metrics_rf.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(["Metric", "Value"])
    writer.writerow(["Accuracy", acc])
    writer.writerow(["AUC", auc_score])
...
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/rf/feature_importance_UNDERSAMLING_rf.png', dpi=300)
plt.show()

# Save feature importances to a CSV file
importance_df.to_csv('analysis_outputs/FINAL_UNDERSAMPLING/rf/feature_importance_UNDERSAMLING_rf.csv', index=False)
...
plt.legend(loc="lower right")
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/rf/roc_curve_rf_final.png', dpi=300)
plt.show()
...
pyplot.subplots_adjust(left=0.20, right=0.85, bottom=0.20, top=0.80)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/rf/confusion_matrix_rf_final.png', dpi=300)
pyplot.show()
...
plt.legend(loc='upper right')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/rf/prob_rf_final.png', dpi=300)
plt.show()
...
plt.grid(True)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/rf/sensitivity_specificity_plot_rf_final.png', dpi=300)
plt.show()
...
# Save results to a CSV file
csv_file_path = 'analysis_outputs/FINAL_UNDERSAMPLING/rf/threshold_metrics_rf.csv'
results_df.to_csv(csv_file_path, index=False)
...
plt.tight_layout()
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/rf/threshold_confusion_matrix_rf.png', dpi=300)
plt.show()
...
plt.legend(loc='best')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/rf/calibration_Plot_rf.png', dpi=300)
plt.show()
...
# Save the figure to a file (DPI 300)
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/rf/shap_summary_plot_rf.png', bbox_inches='tight', dpi=300)
plt.close()
...
# Save the model
joblib_file = f'{output_dir}/FINAL_UNDERSAMPLING/xgb/xgb_model_UNDERSAMPLING_FINAL.pkl'
...
# Output predicted probabilities for test data to a CSV file
df_test['pred_proba'] = y_pred_proba
df_test.to_csv(f'{output_dir}/FINAL_UNDERSAMPLING/xgb/Results_UNDERSAMPLING_with_pred_proba.csv', index=False)
...
# Write metrics to a CSV file.
with open(f'{output_dir}/FINAL_UNDERSAMPLING/xgb/metrics_xgb.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(["Metric", "Value"])
    writer.writerow(["Accuracy", acc])
    writer.writerow(["AUC", auc_score])
...
plt.gca().invert_yaxis()
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/xgb/feature_importance_UNDERSAMLING_xgb.png', dpi=300)
plt.show()

# Save feature importances to a CSV file
importance_df.to_csv('analysis_outputs/FINAL_UNDERSAMPLING/xgb/feature_importance_UNDERSAMLING_xgb.csv', index=False)
...
plt.legend(loc="lower right")
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/xgb/roc_curve_xgb_final.png', dpi=300)
plt.show()
...
pyplot.subplots_adjust(left=0.20, right=0.85, bottom=0.20, top=0.80)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/xgb/confusion_matrix_xgb_final.png', dpi=300)
pyplot.show()
...
plt.legend(loc='upper right')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/xgb/prob_xgb_final.png', dpi=300)
plt.show()
...
plt.grid(True)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/xgb/sensitivity_specificity_plot_xgb_final.png', dpi=300)
plt.show()
...
# Save results to a CSV file
csv_file_path = 'analysis_outputs/FINAL_UNDERSAMPLING/xgb/threshold_metrics_xgb.csv'
results_df.to_csv(csv_file_path, index=False)
...
plt.tight_layout()
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/xgb/threshold_confusion_matrix_xgb.png', dpi=300)
plt.show()
...
plt.legend(loc='best')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/xgb/calibration_Plot_xgb.png', dpi=300)
plt.show()
...
# Save the figure to a file (DPI 300)
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/xgb/shap_summary_plot_xgb.png', bbox_inches='tight', dpi=300)
plt.close()
...
# Save the model
joblib_file = f'{output_dir}/FINAL_UNDERSAMPLING/lgb/lgb_model_UNDERSAMPLING_FINAL.pkl'
...
# Output predicted probabilities for test data to a CSV file
df_test['pred_proba'] = y_pred_proba
df_test.to_csv(f'{output_dir}/FINAL_UNDERSAMPLING/lgb/Results_UNDERSAMPLING_with_pred_proba.csv', index=False)
...
# Write metrics to a CSV file.
with open(f'{output_dir}/FINAL_UNDERSAMPLING/lgb/metrics_lgb.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(["Metric", "Value"])
    writer.writerow(["Accuracy", acc])
    writer.writerow(["AUC", auc_score])
...
plt.gca().invert_yaxis()
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/lgb/feature_importance_UNDERSAMLING_lgb.png', dpi=300)
plt.show()

# Save feature importances to a CSV file
importance_df.to_csv('analysis_outputs/FINAL_UNDERSAMPLING/lgb/feature_importance_UNDERSAMLING_lgb.csv', index=False)
...
plt.legend(loc="lower right")
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/lgb/roc_curve_lgb_final.png', dpi=300)
plt.show()
...
pyplot.subplots_adjust(left=0.20, right=0.85, bottom=0.20, top=0.80)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/lgb/confusion_matrix_lgb_final.png', dpi=300)
pyplot.show()
...
plt.legend(loc='upper right')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/lgb/prob_lgb_final.png', dpi=300)
plt.show()
...
plt.grid(True)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/lgb/sensitivity_specificity_plot_lgb_final.png', dpi=300)
plt.show()
...
# Save results to a CSV file
csv_file_path = 'analysis_outputs/FINAL_UNDERSAMPLING/lgb/threshold_metrics_lgb.csv'
results_df.to_csv(csv_file_path, index=False)
...
plt.tight_layout()
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/lgb/threshold_confusion_matrix_lgb.png', dpi=300)
plt.show()
...
plt.legend(loc='best')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/lgb/calibration_Plot_lgb.png', dpi=300)
plt.show()
...
# Save the figure to a file (DPI 300)
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/lgb/shap_summary_plot_lgb.png', bbox_inches='tight', dpi=300)
plt.close()
...
# Save the model
joblib_file = f'{output_dir}/FINAL_UNDERSAMPLING/LR/LR_model_UNDERSAMPLING_FINAL.pkl'
joblib.dump(LR, joblib_file)

# Verify that the LR-named artifact contains the fitted LR model and reproduces
# the probabilities calculated immediately before serialization.
saved_LR = joblib.load(joblib_file)
if not isinstance(saved_LR, LogisticRegression):
    raise TypeError(
        f'Expected LogisticRegression in {joblib_file}, '
        f'found {type(saved_LR).__name__}'
    )
saved_LR_pred_proba = saved_LR.predict_proba(X_test_final)[:, 1]
...
# Output predicted probabilities for test data to a CSV file
df_test['pred_proba'] = y_pred_proba
df_test.to_csv(f'{output_dir}/FINAL_UNDERSAMPLING/LR/Results_UNDERSAMPLING_with_pred_proba.csv', index=False)
...
# Write metrics to a CSV file.
with open(f'{output_dir}/FINAL_UNDERSAMPLING/LR/metrics_LR.csv', 'w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(["Metric", "Value"])
    writer.writerow(["Accuracy", acc])
    writer.writerow(["AUC", auc_score])
...
plt.legend(loc="lower right")
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/LR/roc_curve_LR_final.png', dpi=300)
plt.show()
...
pyplot.subplots_adjust(left=0.20, right=0.85, bottom=0.20, top=0.80)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/LR/confusion_matrix_LR_final.png', dpi=300)
pyplot.show()
...
plt.legend(loc='upper right')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/LR/prob_LR_final.png', dpi=300)
plt.show()
...
plt.grid(True)
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/LR/sensitivity_specificity_plot_LR_final.png', dpi=300)
plt.show()
...
# Save results to a CSV file
csv_file_path = 'analysis_outputs/FINAL_UNDERSAMPLING/LR/threshold_metrics_LR.csv'
results_df.to_csv(csv_file_path, index=False)
...
plt.tight_layout()
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/LR/threshold_confusion_matrix_LR.png', dpi=300)
plt.show()
...
plt.legend(loc='best')
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/LR/calibration_Plot_LR.png', dpi=300)
plt.show()
...
coef_df.to_csv('analysis_outputs/FINAL_UNDERSAMPLING/LR/Model_Coefficients.csv', index=False)
...
# Save the plot at 300 dpi
plt.savefig('analysis_outputs/FINAL_UNDERSAMPLING/roc_curve_all_models_UNDERSAMPLING.png', dpi=300)
plt.show()
