...
`rfecv_features.csv` lists the RFECV36 features, the 36 predictors selected by
recursive feature elimination with cross-validation.  `model_hyperparameters_used.csv`
lists the hyperparameters used for model fitting.
